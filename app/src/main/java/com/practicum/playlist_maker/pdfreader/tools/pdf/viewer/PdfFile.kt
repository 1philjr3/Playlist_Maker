...
import com.practicum.playlist_maker.pdfreader.tools.pdf.viewer.util.PageSizeCalculator
...
//        val removedPdfDocLength = adjustDocumentList(documentsDetails, MergeType.TOP)
        ...
        pdfFile.setUpMergeData(mergeId, this, documentsDetails, startPage,
            MergeType.TOP, pageToLoad, 0f)
    }
